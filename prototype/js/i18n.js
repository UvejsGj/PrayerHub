...
PH.i18n = (function () {
  const dict = {
    en: {
      ...
      'footer.privacy': 'Privacy Policy', 'footer.demo': 'Demo slice — full architecture in',
      'top.searchCity': 'Search city…', 'top.country': 'Country', 'top.search': 'Search', 'top.auto': 'Auto',
      'loc.title': 'Choose location', 'loc.sub': 'Pick your country, then your city.',
      'loc.useGps': 'Use my current location', 'loc.or': 'or choose manually',
      'loc.country': 'Country', 'loc.city': 'City',
      'loc.countryPh': 'Search country…', 'loc.cityPh': 'Select a country first', 'loc.cityPhReady': 'Search city…',
      'loc.loadingCities': 'Loading cities…', 'loc.citiesFail': "Couldn't load cities — type your city name.",
      'loc.resolving': 'Finding coordinates…', 'loc.set': 'Location set:',
      'loc.detecting': 'Detecting your location…', 'loc.gpsDenied': 'Location permission denied — choose manually.',
      'loc.gpsUnsupported': 'Geolocation not supported.', 'loc.noMatch': 'No matches', 'loc.more': 'Keep typing to narrow…',
      ...
      'auth.forgot': 'Forgot password?', 'auth.needBoth': 'Enter an email and a password of at least 6 characters.',
      'auth.working': 'Working…', 'auth.signedIn': 'Signed in — your data is now syncing.',
      'auth.needEmail': 'Enter your email above first, then tap Forgot password.',
      'auth.sending': 'Sending reset link…', 'auth.resetSent': 'Check your email for a password-reset link.',
      'auth.recoverTitle': 'Set a new password', 'auth.recoverSub': 'Choose a new password for your account.',
    ...
    sq: {
      ...
      'footer.privacy': 'Politika e Privatësisë', 'footer.demo': 'Pjesë demo — arkitektura e plotë në',
      'top.searchCity': 'Kërko qytetin…', 'top.country': 'Shteti', 'top.search': 'Kërko', 'top.auto': 'Auto',
      'loc.title': 'Zgjidh vendndodhjen', 'loc.sub': 'Zgjidh shtetin, pastaj qytetin.',
      'loc.useGps': 'Përdor vendndodhjen time', 'loc.or': 'ose zgjidh manualisht',
      'loc.country': 'Shteti', 'loc.city': 'Qyteti',
      'loc.countryPh': 'Kërko shtetin…', 'loc.cityPh': 'Zgjidh fillimisht shtetin', 'loc.cityPhReady': 'Kërko qytetin…',
      'loc.loadingCities': 'Duke ngarkuar qytetet…', 'loc.citiesFail': 'Nuk u ngarkuan qytetet — shkruaj emrin e qytetit.',
      'loc.resolving': 'Duke gjetur koordinatat…', 'loc.set': 'Vendndodhja u vendos:',
      'loc.detecting': 'Duke gjetur vendndodhjen…', 'loc.gpsDenied': 'Leja u refuzua — zgjidh manualisht.',
      'loc.gpsUnsupported': 'Gjeolokacioni nuk mbështetet.', 'loc.noMatch': 'Nuk ka përputhje', 'loc.more': 'Vazhdo të shkruash për të ngushtuar…',
      ...
      'auth.forgot': 'Keni harruar fjalëkalimin?', 'auth.needBoth': 'Vendos një email dhe një fjalëkalim me të paktën 6 shenja.',
      'auth.working': 'Duke punuar…', 'auth.signedIn': 'U kyçët — të dhënat tuaja po sinkronizohen.',
      'auth.needEmail': 'Vendos fillimisht email-in lart, pastaj prek “Keni harruar fjalëkalimin?”.',
      'auth.sending': 'Duke dërguar lidhjen…', 'auth.resetSent': 'Kontrollo email-in për lidhjen e rivendosjes së fjalëkalimit.',
      'auth.recoverTitle': 'Vendos një fjalëkalim të ri', 'auth.recoverSub': 'Zgjidh një fjalëkalim të ri për llogarinë tënde.',
